			...
			<div style="margin:10px;margin-right:10px;">
				<div id="choixDate" class="row">
					<section id="rechercheMobile">
						...
						<form method="POST" action="http://localhost/Projet CHU-Gyneco-Obstetrique/mysql/bilan/ordonneeNaissance.php" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<label>Année:</label>
				...
				<div class="row" style="background: url('http://localhost/Projet CHU-Gyneco-Obstetrique/image/fondAjout.jpg');margin:10px; " id="histo">		
					<div class="panel-heading" style="background:rgb(0,50,0);color:#EEE;height:50px;padding-top:5px;"> <h4>Histogramme des naissances</h4> </div><br/>
      				<div class="col-lg-12 col-md-12 col-sm-12">
         				<img src="diagNaissance.php" alt="histogramme" style="margin:10px;margin-top:0px;margin-bottom:20px;">
     	 			</div>
     	 			<a href="diagNaissance.php"><button type="submit" class="btnService" style="width:90px;height:40px;float:right;margin-right:15px;margin-bottom:15px;">Imprimer</button></a>
				</div>
			</div>
		</div>
		</div>
