			...
			<div style="margin:10px;margin-right:10px;">
				<div id="choixDate" class="row">
					<section id="rechercheMobile">
						...
						<form method="POST" action="http://localhost/Projet CHU-Gyneco-Obstetrique/mysql/bilan/ordonneeRepartition.php" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<label>Année:</label>
							<input type="texte" id="annee" name="annee" class="form-group form-control input-md" style="width:200px;display:inline;"/>						
							<button type="submit" class="btnGest">Afficher</button><br/><br/>
						</form>
					</section>		
				</div>
				<div class="row" style="background: url('http://localhost/Projet CHU-Gyneco-Obstetrique/image/fondAjout.jpg');margin:10px;" id="pourcentage">		
					<div class="panel-heading" style="background:rgb(0,50,0);color:#EEE;height:50px;padding-top:5px;"> <h4>Répartition des activités</h4> </div><br/>
      				<div class="col-lg-12 col-md-12 col-sm-12">
         				<img src="repartition.php" alt="pourcentage" style="margin:10px;margin-top:0px;margin-bottom:20px;">
     	 			</div>
     	 			<a href="repartition.php"><button type="submit" class="btnService" style="width:90px;height:40px;float:right;margin-right:15px;margin-bottom:15px;">Imprimer</button></a>
				</div>
			</div>
		</div>
		</div>
