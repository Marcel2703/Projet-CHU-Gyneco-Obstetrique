...
<script type="text/javascript" src="http://localhost/Projet CHU-Gyneco-Obstetrique/javascript/scriptExamen.js"></script>
<div id="formExamen" class="row">
	...
	<div style="margin:10px;margin-right:10px;">
		<div class="panel-heading" style="background:rgb(0,50,0);color:#EEE;height:50px;padding-top:5px;"> <h4>Ajouter les examens avant entrée de la patiente séléctionnée</h4> </div>
		...
		<div class="form-group" id="ajoutPerso">
			<div class="row">
			<form>
				<div class="col-lg-5 col-md-5 col-sm-5">
  					<div class="form-group">
					<input type="text" id="element" placeholder="Saisir libellé de l'examen" class="form-control" style="width:250px;height:40px;display:inline-block;padding:4px;"/>				
				...
				<div class="col-lg-offset-4 col-lg-7 col-md-offset-4 col-md-7 col-sm-offset-4 col-sm-7 col-xs-offset-4 col-xs-7">
					<form id="my_form" method="post" action="http://localhost/Projet CHU-Gyneco-Obstetrique/action/patients/examen/uploadImage.php" enctype="multipart/form-data">
				...
				<div id="tableAfenina" class="row" style="display:none;margin:15px;">
					<table  class="table table-bordered table-hover" style="color:black;">
						<thead>
						<tr class="success">
							<th class="col-lg-2 col-md-3 col-sm-3 col-xs-3">Elements</th>
							<th class="col-lg-3 col-md-5 col-sm-5 col-xs-5">Valeur</th>
