...
$bdd= new Database();
$recherchePatiente=$_POST['recherchePatiente'];
$ligne=$bdd->requete("SELECT * FROM patiente WHERE id_registre LIKE '%$recherchePatiente%' OR nom_patiente LIKE '%$recherchePatiente%' OR gestite LIKE '%$recherchePatiente%' OR parite LIKE '%$recherchePatiente%' ORDER BY id_registre DESC");
