...
$bdd= new Database();
$rechercheRegistreExam=$_POST['rechercheRegistreExam'];
$ligne=$bdd->requete("SELECT * FROM patiente WHERE id_registre LIKE '%$rechercheRegistreExam%' OR nom_patiente LIKE '%$rechercheRegistreExam%'");
