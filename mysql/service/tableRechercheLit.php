...
$bdd= new Database();
$rechercheLit=$_POST['rechercheLit'];
$ligne=$bdd->requete("SELECT * FROM lit WHERE id_lit LIKE '%$rechercheLit%' OR id_chambre LIKE '%$rechercheLit%' OR occupation LIKE '%$rechercheLit%' ORDER BY id_chambre");
