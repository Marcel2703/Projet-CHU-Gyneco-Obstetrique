...
$bdd= new Database();
$rechercheChambre=$_POST['rechercheChambre'];
$ligne=$bdd->requete("SELECT chambre.id_chambre AS id_chambre,chambre.code_categorie AS code_categorie,categorie.nb_occup AS dispo_total,chambre.place_occup AS place_occup FROM chambre,categorie WHERE (chambre.code_categorie=categorie.code_categorie AND chambre.id_chambre LIKE '%$rechercheChambre%') OR chambre.code_categorie LIKE '%$rechercheChambre%' ORDER BY id_chambre");
