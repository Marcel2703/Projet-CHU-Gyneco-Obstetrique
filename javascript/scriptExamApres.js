  ...
  $('#rechercheRegistreExam').keyup(function()
        {
          ...
          $.ajax({
                  url: "http://localhost/Projet CHU-Gyneco-Obstetrique/mysql/patients/tableRechercheRegistreExamApres.php",
                  type: "POST",
...
function deleteExam(){
   if (confirm('Voulez-vous vraiment supprimer cet examen clinique en cours de séjour?'))
        {
...
function ajoutExamen()
    {
      ...
      var element = $("#elementApres").val();
      var valeur = $("#valeurApres").val();
      ...
      $.ajax({
        ...
        url: "http://localhost/Projet CHU-Gyneco-Obstetrique/action/patients/examenApres/ajoutExamApres.php",
        type: "POST",
...
function choixRegistre(lien){
   $.get(lien,function(data){
      ...
      var nom=tabHaza[1];
    if (confirm('Voulez-vous passer à l\'écritures de l\'examen clinique en cours de séjour de Mme '+nom+' ?')){
           $('#nomPatiente').empty();
...
function remplirListeExamen()
    {
      $.get("http://localhost/Projet CHU-Gyneco-Obstetrique/mysql/patients/listeExamenApres.php",function(data){
